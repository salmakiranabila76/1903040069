...
<body style="background: url(images/yel.jpg) no-repeat; background-size: cover;">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/imm.png" width="100" alt="IMMjaya">
                                <img src="images/icon/label imm.png" width="250" alt="IMMjaya">
                                <label>Username dan Password = admin123</label>
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <br>
                                <button name="btnLogin" class="au-btn au-btn--block btn-warning m-b-20" type="submit">sign in</button>
                            </form>
                        </div>
                    </div>
                </div>
